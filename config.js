var config = {
    style: 'mapbox://styles/blueberrima/cmd7jzkog04on01sd7qgf2c24',
    // leave commented to use Mapbox Standard Style
    accessToken: 'pk.eyJ1IjoiYmx1ZWJlcnJpbWEiLCJhIjoiY21kN2pxbXhkMHAwZjJrcXYzaWpyNGczdSJ9.cfgUwj_eYFGhdMJi1oWg4g',
    showMarkers: false,
    markerColor: '#3FB1CE',
    ...
    chapters: [
        {
            ...
            location: {
                center: [-17.925681062343745,28.59669572724002],
                zoom: 12.5,
                pitch: 62.77,
                bearing: -8.80
            },
        ...
        },
        {
            ...
            location: {
                center: [-17.843082426325292,28.45525188856689],
                zoom: 8.5,
                pitch: 60,
                bearing: -43.2,
        ...
        },
        {
            ...
            location: {
                center: [-17.760493231040904,28.569912446773365],
                zoom: 12.52,
                pitch: 8.01,
                bearing: 0.00
            },
        ...
        },
        {
            ...
            location: {
                center: [-17.778064945731167,28.839025677029376],
                zoom: 4,
                pitch: 0,
                bearing: 0
            },
